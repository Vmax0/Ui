for _, v in ipairs(game.CoreGui:GetChildren()) do
    if v.Name == "ScreenGui" or v.Name == "PV ON/OFF" then
        v:Destroy()
    end
end
...
local L_3_ = {
	...
	[49] = function()
		...
		return {
			Name = 'Aqua',
Accent = Color3.fromRGB(135, 206, 235), -- light blue-green
AcrylicMain = Color3.fromRGB(45, 120, 150), -- darker blue-green
AcrylicBorder = Color3.fromRGB(80, 180, 220), -- lighter blue-green
AcrylicGradient = ColorSequence.new(Color3.fromRGB(120, 200, 240), Color3.fromRGB(90, 160, 200)),
AcrylicNoise = 0.96,
TitleBarLine = Color3.fromRGB(120, 200, 240), -- light blue-green
Tab = Color3.fromRGB(160, 220, 250), -- pale blue-green
Element = Color3.fromRGB(140, 210, 240), -- light blue-green
ElementBorder = Color3.fromRGB(60, 140, 180), -- darker blue-green
InElementBorder = Color3.fromRGB(100, 180, 220), -- lighter blue-green
ElementTransparency = 0.85,
ToggleSlider = Color3.fromRGB(140, 210, 240), -- light blue-green
ToggleToggled = Color3.fromRGB(0, 0, 0), -- black
SliderRail = Color3.fromRGB(140, 210, 240), -- light blue-green
DropdownFrame = Color3.fromRGB(180, 240, 260), -- pale blue-green
DropdownHolder = Color3.fromRGB(60, 140, 180), -- darker blue-green
DropdownBorder = Color3.fromRGB(60, 120, 150), -- darker blue-green
DropdownOption = Color3.fromRGB(140, 210, 240), -- light blue-green
Keybind = Color3.fromRGB(140, 210, 240), -- light blue-green
Input = Color3.fromRGB(140, 210, 240), -- light blue-green
InputFocused = Color3.fromRGB(20, 10, 30), -- dark blue
InputIndicator = Color3.fromRGB(150, 220, 250), -- pale blue-green
Dialog = Color3.fromRGB(60, 140, 180), -- darker blue-green
DialogHolder = Color3.fromRGB(50, 120, 150), -- darker blue-green
DialogHolderLine = Color3.fromRGB(45, 110, 140), -- darker blue-green
DialogButton = Color3.fromRGB(60, 140, 180), -- darker blue-green
DialogButtonBorder = Color3.fromRGB(100, 180, 220), -- lighter blue-green
DialogBorder = Color3.fromRGB(80, 160, 200), -- lighter blue-green
DialogInput = Color3.fromRGB(55, 130, 160), -- darker blue-green
DialogInputLine = Color3.fromRGB(150, 220, 250), -- pale blue-green
Text = Color3.fromRGB(240, 240, 240), -- white
SubText = Color3.fromRGB(2, 12, 13), -- light gray
Hover = Color3.fromRGB(140, 210, 240), -- light blue-green
HoverChange = 0.04
		}
	end,
	[50] = function()
